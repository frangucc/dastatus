...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__walkthrough_modal__ = __webpack_require__(349);
...
var WalkthroughModalPageModule = /** @class */ (function () {
    ...
    WalkthroughModalPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_0__walkthrough_modal__["a" /* WalkthroughModalPage */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_0__walkthrough_modal__["a" /* WalkthroughModalPage */]
            ]
...
var WalkthroughModalPage = /** @class */ (function () {
    ...
    WalkthroughModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-walkthrough-modal',template:/*ion-inline-start:"C:\Users\User\Desktop\app1\src\pages\popup-modal\walkthrough-modal\walkthrough-modal.html"*/'<ion-content [style.background-color]="color" class="round">\n  <ion-slides pager class="round-top">\n    <ion-slide *ngFor="let slide of slides" class="text-center slider-item" [ngStyle]="{\'background-image\': \'url(\' + slide.imageUrl +\')\'}">\n      <div class="slide-text">\n        <h2>{{slide.title}}</h2>\n        <p>{{slide.songs}} songs</p>\n      </div>\n    </ion-slide>\n  </ion-slides>\n  <button ion-button full class="footer-button" (click)="dismiss()">Let\'s get started!</button>\n</ion-content>\n'/*ion-inline-end:"C:\Users\User\Desktop\app1\src\pages\popup-modal\walkthrough-modal\walkthrough-modal.html"*/
        }),
